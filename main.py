...
app.config['MYSQL_PASSWORD'] = '@Abhi#26B02'
...
# http://localhost:5000/pythonlogin/contact - this will be the contact page
...
def contact():
    ...
    if request.method == 'POST' and 'name' in request.form and 'email' in request.form and 'message' in request.form:
        ...
        if not name or not email or not message:
            ...
            cursor = mysql.connection.cursor(MySQLdb.cursors.DictCursor)
            cursor.execute('INSERT INTO contact_us VALUES (NULL, %s, %s, %s)', (name, email, message,))
            mysql.connection.commit()
